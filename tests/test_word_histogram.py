...
class TestWordHistogram(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_text = (
            "This is a test. This test has repeated words, words, words!"
        )
    ...
    def test_count_words(self):
        ...
        expected = Counter({
            "this": 2, "is": 1, "a": 1, "test": 2,
            "has": 1, "repeated": 1, "words": 3
        })
    ...
    def test_save_to_text(self):
        ...
        self.assertIn("3          words", content)  # Adjusted space
        self.assertIn("2          this", content)  # Adjusted space
        self.assertIn("2          test", content)  # Adjusted space
